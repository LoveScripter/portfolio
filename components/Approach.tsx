      ...
      <h1 className="heading">
        ...
        <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
          ...
          title="Development & Progress Update"
            ...
            description="Once we agree on the plan, I cue my lofi playlist and dive into coding. From initial sketchesto polished code, I keep you updated every step of the way"
            >
            <CanvasRevealEffect
              animationSpeed={3}
